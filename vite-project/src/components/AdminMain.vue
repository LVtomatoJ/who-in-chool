<template>
  ...
  <el-drawer v-model="userdrawer" size="70%" title="编辑用户">
    <el-form>
  ...
  <el-drawer v-model="noticdrawer" size="70%" title="编辑公告">
    <el-form>
  ...
  <el-drawer v-model="binddrawer" size="70%" title="编辑绑定">
    <el-form>
  ...
  <el-drawer v-model="workdrawer" size="70%" title="编辑任务">
    <el-form>
